...
public class Render {
	...
	if (rayTracerBase == null) throw new MissingResourceException("one of the args of Render is null",
		RayTracerBasic.class.getName(), "rayTracerBase");
	...
	if (imageWriter == null) throw new MissingResourceException("imageWriter is null, Illegal ", "imageWriter", "");
