...
public class ShadowTests {
	...
	public void sphereTriangleInitialMoveLight1() {
		...
		Render render = new Render(). //
				setImageWriter(new ImageWriter("shadow Sphere Triangle Initial Light More Down", 400, 400)) //
				.setCamera(camera) //
				.setRayTracer(new RayTracerBasic(scene));
		render.renderImage();
		render.writeToImage();
	...
	public void sphereTriangleInitialMoveLight2() {
		...
		Render render = new Render(). //
				setImageWriter(new ImageWriter("shadow Sphere Triangle Initial Light More Down Cover Half Sphere", 400, 400)) //
				.setCamera(camera) //
				.setRayTracer(new RayTracerBasic(scene));
		render.renderImage();
		render.writeToImage();
	...
	public void sphereTriangleInitialMoveTriangle1() {
		...
		Render render = new Render(). //
				setImageWriter(new ImageWriter("shadow Sphere Triangle Initial Move Triangle", 400, 400)) //
				.setCamera(camera) //
				.setRayTracer(new RayTracerBasic(scene));
		render.renderImage();
		render.writeToImage();
	...
	public void sphereTriangleInitialMoveTriangle2() {
		...
		Render render = new Render(). //
				setImageWriter(new ImageWriter("shadow Sphere Triangle Initial Move Triangle 2", 400, 400)) //
				.setCamera(camera) //
				.setRayTracer(new RayTracerBasic(scene));
		render.renderImage();
		render.writeToImage();
