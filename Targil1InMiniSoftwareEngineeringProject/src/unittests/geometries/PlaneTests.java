...
public class PlaneTests {
    ...
    public void testConstructor() {
		...
		//assertThrows("failure text", IllegalArgumentException.class, new Plane(new Point3D(0, 2, 0),new Point3D(0, 3, 0),new Point3D(0, 4, 0))); 
	...
	public void testFindIntersections() {
		...
		assertEquals("Ray is neither orthogonal nor parallel to and begins at the plane",null,p.findIntersections(ray8));
		...
		assertEquals("Ray is neither orthogonal nor parallel to the plane and begins in\r\n"
				+ "		//the same point which appears as reference point in the plane (Q)",null,p.findIntersections(ray9));
	}
