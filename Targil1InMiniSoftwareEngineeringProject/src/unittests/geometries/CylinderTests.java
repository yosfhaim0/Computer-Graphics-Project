...
public class CylinderTests {
	...
	public void testGetMiddlePoint() {
		...
		// TC01: middle point is the center
		assertEquals("the middle point expected", new Point3D(2, 0, 0.5d), cylinder.getMiddlePoint());
		cylinder = new Cylinder(new Ray(Point3D.ZERO, new Vector(new Point3D(1, 0, 0))), 2, 2);
		cylinder.createBox();
		// TC01: middle point is the center
		assertEquals("the middle point expected", new Point3D(1, 0, 0), cylinder.getMiddlePoint());
	}
