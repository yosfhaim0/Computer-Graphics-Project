...
public abstract class Intersectable {
	 ...
	 * 
	 * @param ray         Gets a Ray that is supposed to cut the shape
	 * @param maxDistance if the point far more then the maxDistance form the start
	 *                    ray point<br>
	 *                    the func not return that point
	 * @return if there are Intersections: List<GeoPoint> Point3D <br>
	 *         Otherwise<br>
	 *         if there are no Intersections: null
	 */
	...
	/**
	 * A function that mathematically calculates the points of intersection of
	 * the<br>
	 * geometric shape with a given ray
	 * 
	 * @param ray         Gets a Ray that is supposed to cut the shape
	 * @param maxDistance if the point far more then the maxDistance form the start
	 *                    ray point<br>
