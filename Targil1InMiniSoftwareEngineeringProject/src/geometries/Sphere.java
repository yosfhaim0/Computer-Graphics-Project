...
public class Sphere extends Geometry {
	...
	try {
	    ...
	    if (alignZero(radius - maxDistance) <= 0) return List.of(new GeoPoint(this, ray.getPoint(radius)));
	    return null;
	}
	...
	if (t2 <= 0) return null;
	if (alignZero(t2 - maxDistance) <= 0) return t1 <= 0 ? List.of(new GeoPoint(this, ray.getPoint(t2)))
